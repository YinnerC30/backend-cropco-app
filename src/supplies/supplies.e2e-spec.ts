...
describe('SuppliesController e2e', () => {
  ...
  async function createTestSupply(data: CreateSupplyDto) {
  ...
  //         expect(supply).toHaveProperty('units');
  //         expect(supply).toHaveProperty('location');
  //         expect(supply).toHaveProperty('date_of_creation');
  //         expect(supply).toHaveProperty('date_of_termination');
  //         expect(supply).toHaveProperty('harvests_stock');
  ...
  //       // Crear un supplye de prueba
  //       await authService.addPermission(userTest.id, 'find_one_supply');
  //       const { id } = await createTestSupply({
  //         name: 'SupplyName3',
  //         description: 'Supply description...',
  //         units: 10,
  //         location: 'Location of the supply...',
  ...
  //       const supplyDemo = await createTestSupply({
  //         name: 'SupplyName4',
  //         description: 'Supply description...',
  //         units: 10,
  //         location: 'Location of the supply...',
  ...
  //         .set('Authorization', `Bearer ${token}`)
  //         .send({
  //           description: 'Change description supply',
  //           location: 'Change location supply',
  //         })
  //         .expect(200);

  //       expect(body.description).toEqual('Change description supply');
  //       expect(body.location).toEqual('Change location supply');
  //       expect(body.name).toEqual('SupplyName4');
  //       expect(body.units).toEqual(supplyDemo.units);
  //       expect(body.date_of_creation).toEqual(
  //         supplyDemo.date_of_creation.split('T')[0],
  //       );
  //     });
  ...
  //         .set('Authorization', `Bearer ${token}`)
  //         .expect(409);
  //       expect(body.message).toEqual(`Supply has stock available`);
  //     });
  //   });
  ...
  //     it('should throw an exception when trying to delete a supply with stock available.', async () => {
  //       // Crear cultivo de prueba
  //       const supply1 = await createTestSupply({
  //         name: 'SupplyName11',
  //         description: 'Supply description...',
  //         units: 10,
  //         location: 'Location of the supply...',
  //         date_of_creation: new Date().toISOString(),
  //       } as CreateSupplyDto);
  //       const supply2 = await createTestSupply({
  //         name: 'SupplyName12',
  //         description: 'Supply description...',
  //         units: 10,
  //         location: 'Location of the supply...',
  //         date_of_creation: new Date().toISOString(),
  //       } as CreateSupplyDto);
  //       const supply3 = await createTestSupply({
  //         name: 'SupplyName13',
  //         description: 'Supply description...',
  //         units: 10,
  //         location: 'Location of the supply...',
  ...
  //           {
  //             id: supply1.id,
  //             error: 'Supply has stock available',
  //           },
  //           {
  //             id: supply2.id,
  //             error: 'Supply has stock available',
